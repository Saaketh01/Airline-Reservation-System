...
This project implements a full stack airline reservation system that allows users to search for flights, book tickets, and manage reservations. The system supports complete CRUD operations for managing flight and booking data efficiently.

## Key Features

**Create:** Users can book new flight tickets by selecting available flights and entering passenger details.
**Read:** Users can view available flights, search based on criteria, and check booking details.
**Update:** Users can modify existing reservations such as changing passenger information or travel details.
**Delete:** Users can cancel existing bookings, and the system updates availability accordingly.
